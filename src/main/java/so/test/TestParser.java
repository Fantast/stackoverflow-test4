// Generated from so/test/TestParser.g4 by ANTLR 4.3
package so.test;
...
public class TestParser extends Parser {
	...
	public static final int
		RBR=3, STRING=2, LBR=1;
	public static final String[] tokenNames = {
		"<INVALID>", "'['", "STRING", "']'"
	};
	public static final int
		RULE_rul = 0, RULE_block = 1;
	...
	public static class RulContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TestParserVisitor ) return ((TestParserVisitor<? extends T>)visitor).visitRul(this);
	...
	public static class BlockContext extends ParserRuleContext {
		public TerminalNode RBR() { return getToken(TestParser.RBR, 0); }
		public TerminalNode LBR() { return getToken(TestParser.LBR, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TestParserVisitor ) return ((TestParserVisitor<? extends T>)visitor).visitBlock(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(9); match(LBR);
			setState(10); match(STRING);
			setState(11); match(RBR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static final String _serializedATN =
		...
		"\t\n\3\2\2\2\n\3\3\2\2\2\13\f\7\3\2\2\f\r\7\4\2\2\r\16\7\5\2\2\16\5\3"+
		"\2\2\2\3\t";
